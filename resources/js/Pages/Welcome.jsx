                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            ...
                            >
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        ...
                                        Tanto si estás empezando como si ya tienes experiencia, vale la pena revisarla de principio a fin.
                                    </p>
                                </div>
                            ...
                            >
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        ...
                                        Échales un vistazo y mejora tus habilidades de desarrollo mientras exploras el ecosistema.
                                    </p>
                                </div>
                            ...
                            >
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        Laravel News es un portal y boletín impulsado por la comunidad que reúne las
                                        noticias más recientes e importantes del ecosistema Laravel, incluidos nuevos paquetes y tutoriales.
                                    </p>
                                </div>
                            ...
                            <div className="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        La sólida biblioteca de herramientas y librerías oficiales de Laravel, como{' '}
                                        <a
                                        ...
                                        te ayuda a llevar tus proyectos al siguiente nivel. También puedes combinarlas con librerías de código abierto como{' '}
                                        <a
